...
to be installed.
    ...
    my $subway = Map::Tube::NYC->new;
    my $line   = 'IND Eighth Avenue';
    open(my $IMAGE, ">$line.png");
    print $IMAGE decode_base64($subway->as_image($line));
    close($IMAGE);

The L<IND Eighth Avenue Line|https://raw.githubusercontent.com/Manwar/Map-Tube-NYC/master/maps/IND-Eighth-Avenue.png>
