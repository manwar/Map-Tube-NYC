...
$Map::Tube::NYC::Line::IRTLexingtonAvenue::VERSION   = '0.33';
...
=item * The station "125th Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "116th Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "110th Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "103rd Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "96th Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "86th Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "33rd Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>.

=item * The station "59th Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>
        | IRT Broadway Line.

=item * The station "42nd Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>
        | L<IRT Flushing Line|Map::Tube::NYC::Line::IRTFlushing>.

=item * The station "23rd Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>
        | L<IND Sixth Avenue|Map::Tube::NYC::Line::INDSixthAvenue>.

=item * The station "14th Street" is also part of L<IND Sixth Avenue|Map::Tube::NYC::Line::INDSixthAvenue>
        | IRT Broadway.

=item * The station "Canal Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>
        | L<BMT Nassau Street|Map::Tube::NYC::Line::BMTNassauStreet>.

=item * The station "Fulton Street" is also part of L<IND Eighth Avenue|Map::Tube::NYC::Line::INDEighthAvenue>
